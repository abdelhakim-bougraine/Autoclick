        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
          <div>
            <h1 className="text-4xl font-black text-gray-900">
              Boutique <span className="text-[#00adef]">AutoClick</span>
            </h1>
            <p className="text-gray-500 font-medium">
              Tout pour votre voiture, livré chez vous.
            </p>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="bg-white p-6 rounded-[2rem] shadow-xl">
              ...
              <ul className="space-y-3 list-none p-0">
                {[
                  ...
                  <li
                    key={cat}
                    className="text-gray-600 font-bold hover:text-[#00adef] cursor-pointer transition-colors"
                  >
                    {cat}
                  </li>
                ))}
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            {products.map((product) => (
              <div
                key={product.id}
                className="bg-white rounded-[2.5rem] overflow-hidden shadow-xl hover:shadow-2xl transition-all group border border-gray-100"
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-2xl font-black text-[#00adef] mb-6">
                    {product.price}
                  </p>
