...
const Home = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans text-left">
      ...
      <div className="relative bg-linear-to-br from-[#00adef] via-[#0088cc] to-[#005f99] py-24 px-6 text-center text-white overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl mb-12 opacity-90 max-w-2xl mx-auto font-medium">
            Lavage, Mécanique ou Dépannage ? Trouvez le professionnel le plus
            proche de vous en un clic.
          </p>

          {/* محرك البحث الجغرافي */}
          <div className="bg-white p-3 rounded-4xl shadow-2xl max-w-4xl mx-auto flex flex-col md:flex-row gap-3">
      ...
      <div className="max-w-7xl mx-auto py-24 px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="bg-white p-10 rounded-[3rem] shadow-xl shadow-gray-200/50 text-center group hover:-translate-y-2.5 transition-all duration-300 border border-gray-50">
            <div className="bg-blue-50 text-[#00adef] w-24 h-24 rounded-4xl flex items-center justify-center mx-auto mb-8 text-4xl group-hover:bg-[#00adef] group-hover:text-white transition-colors">
              <FaCar />
            </div>
            ...
            <p className="text-gray-500 font-medium mb-8 leading-relaxed">
              Réservez un lavage complet ou un diagnostic mécanique chez nos
              partenaires agréés.
            </p>
            <button className="bg-gray-900 text-white px-8 py-3 rounded-xl font-bold border-none cursor-pointer hover:bg-[#00adef]">
              Découvrir
            </button>
          </div>
          ...
          <div className="bg-white p-10 rounded-[3rem] shadow-xl shadow-gray-200/50 text-center group hover:-translate-y-2.5 transition-all duration-300 border border-gray-50">
            <div className="bg-orange-50 text-orange-500 w-24 h-24 rounded-4xl flex items-center justify-center mx-auto mb-8 text-4xl group-hover:bg-orange-500 group-hover:text-white transition-colors">
              <FaShoppingBag />
            </div>
            <h3 className="text-2xl font-black text-gray-900 mb-4">
              Boutique Pièces
            ...
            <p className="text-gray-500 font-medium mb-8 leading-relaxed">
              Accessoires, huiles, et pièces de rechange. Tout ce qu'il faut
              pour votre voiture.
            </p>
            <button className="bg-gray-900 text-white px-8 py-3 rounded-xl font-bold border-none cursor-pointer hover:bg-orange-500">
              Acheter
            </button>
          </div>

          {/* قسم النجدة - Urgence SOS */}
          <div className="bg-white p-10 rounded-[3rem] shadow-xl shadow-red-100 text-center group hover:-translate-y-2.5 transition-all duration-300 border-2 border-red-50">
            <div className="bg-red-50 text-red-500 w-24 h-24 rounded-4xl flex items-center justify-center mx-auto mb-8 text-4xl group-hover:bg-red-500 group-hover:text-white transition-colors">
              <FaTruckPickup />
            </div>
            ...
            <p className="text-gray-500 font-medium mb-8 leading-relaxed">
              En panne ? Un remorqueur ou un mécanicien mobile arrive chez vous
              en moins de 30 min.
            </p>
            <button className="bg-red-600 text-white px-8 py-3 rounded-xl font-bold border-none cursor-pointer hover:bg-black">
              Appeler Aide
            </button>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto mb-24 px-6">
        <div className="bg-gray-900 rounded-[4rem] p-12 md:p-20 text-center text-white relative overflow-hidden shadow-3xl">
          ...
          <p className="text-gray-400 mb-12 max-w-2xl mx-auto text-lg font-medium leading-relaxed">
            Rejoignez AutoClick, augmentez votre visibilité et recevez des
            clients directement depuis leur position GPS. Simple, efficace et
            rentable.
          </p>
